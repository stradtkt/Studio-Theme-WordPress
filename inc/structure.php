		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<?php  
        		...
        		$defaults = array(
        			...
        			'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s<li class="social-menu-item">' . wp_nav_menu( $social_defaults ) . '</li></ul>',
        		);
		...
		<div id="page-site-header" class="relative" style="background-image: url('<?php echo esc_url( $header_image ); ?>');">
            ...
            <div class="wrapper">
                <header class="page-header">
                    <h2 class="page-title"><?php echo musicsong_custom_header_banner_title(); ?></h2>
                </header>
