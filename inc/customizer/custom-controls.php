 ...
 */
class Musicsong_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Musicsong_Dropdown_Category_Control extends WP_Customize_Control {
...
class Musicsong_Note_Control extends WP_Customize_Control {
...
class Musicsong_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Musicsong_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="musicsong-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Musicsong_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="musicsong-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Musicsong_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Musicsong_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="musicsong-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'musicsong' ); ?>" class="musicsong-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Musicsong_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Musicsong_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
